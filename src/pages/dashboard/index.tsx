...
import StoreLocations from './components/StoreLocations'
import SupplierManagement from './components/SupplierManagement'
import { GitHubStatus } from './components/github-status' // We'll create this
        ...
        >
          <div className='w-full overflow-x-auto pb-2'>
            <TabsList>
              ...
              <TabsTrigger value='inventoryManagement'>Inventory</TabsTrigger>
              <TabsTrigger value='marketingCampaigns'>Marketing</TabsTrigger>
              <TabsTrigger value='storeLocations'>Store Locations</TabsTrigger>
              <TabsTrigger value='supplierManagement'>Suppliers</TabsTrigger>
            </TabsList>
          </div>
